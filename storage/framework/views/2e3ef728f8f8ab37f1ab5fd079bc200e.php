...
<nav class="space-y-1">
    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <a href="<?php echo e(route($item['route'])); ?>" class="group flex items-center gap-3 rounded px-3 py-2 text-sm font-semibold transition <?php echo e(request()->routeIs($item['route']) ? 'bg-blue-500 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white'); ?>">
            <svg class="h-5 w-5 shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="<?php echo e($item['icon']); ?>"/></svg>
            <span><?php echo e($item['label']); ?></span>
        </a>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</nav>
<?php /**PATH C:\Users\bhard\Documents\Codex\2026-05-13\build-me-a-full-logistics-delivery\resources\views/components/sidebar-nav.blade.php ENDPATH**/ ?>