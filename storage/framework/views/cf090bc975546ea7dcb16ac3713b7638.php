    ...
    <div class="min-h-screen flex" x-data="registerForm()">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center px-8 lg:px-24 bg-slate-950 py-12">
            <div class="max-w-md w-full mx-auto">
                ...
                <form action="<?php echo e(route('register')); ?>" method="POST" class="space-y-5" @submit="validateForm">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Swift-Ship\resources\views/auth/customer-register.blade.php ENDPATH**/ ?>