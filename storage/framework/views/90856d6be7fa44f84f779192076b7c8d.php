...
<span <?php echo e($attributes->merge(['class' => 'inline-flex items-center rounded border px-2 py-1 text-xs font-semibold uppercase tracking-wide '.$colors[$status]])); ?>>
    <?php echo e(str($status)->headline()); ?>

</span>
<?php /**PATH C:\Users\bhard\Documents\Codex\2026-05-13\build-me-a-full-logistics-delivery\resources\views/components/status-badge.blade.php ENDPATH**/ ?>