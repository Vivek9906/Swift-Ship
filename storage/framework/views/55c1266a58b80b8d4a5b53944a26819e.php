...
<tr class="border-b border-slate-800 transition hover:bg-slate-800/60">
    <td class="px-4 py-3">
        <input form="bulk-form" type="checkbox" name="shipment_ids[]" value="<?php echo e($shipment->id); ?>" class="rounded border-slate-600 bg-slate-950 text-blue-500">
    </td>
    <td class="px-4 py-3 font-mono text-blue-200">
        <a href="<?php echo e(route('shipments.show', $shipment)); ?>" class="hover:text-blue-100"><?php echo e($shipment->tracking_number); ?></a>
    </td>
...
<?php /**PATH C:\Users\bhard\Documents\Codex\2026-05-13\build-me-a-full-logistics-delivery\resources\views/components/shipment-row.blade.php ENDPATH**/ ?>