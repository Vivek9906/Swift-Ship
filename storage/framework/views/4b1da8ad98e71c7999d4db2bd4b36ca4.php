  ...
  <div class="pt-20 pb-12 min-h-screen">
    <div class="mx-auto max-w-7xl px-4 sm:px-6">
      ...
      <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 class="text-2xl font-black text-white">Welcome back, <?php echo e(auth()->user()->name); ?>! 👋</h1>
...
<?php /**PATH D:\Swift-Ship\resources\views/customer/dashboard.blade.php ENDPATH**/ ?>