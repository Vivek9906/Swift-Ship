...
<div class="wrap">
  ...
  <div class="body">
    <p style="font-size:16px;font-weight:700;color:#0f172a;">Hi <?php echo e($lead->name); ?>, we received your message! 👋</p>
    ...
    <p style="color:#475569;"><strong>Your inquiry summary:</strong><br>Company: <?php echo e($lead->company); ?><br>Business Type: <?php echo e($lead->business_type); ?><br>Monthly Volume: <?php echo e($lead->monthly_volume); ?></p>
    <p style="color:#475569;">Questions? Email us at <a href="mailto:ops@swiftship.in" style="color:#f59e0b;">ops@swiftship.in</a></p>
  </div>
  <div class="footer">© <?php echo e(date('Y')); ?> SwiftShip. All rights reserved.</div>
</div>
</body></html>
<?php /**PATH D:\Swift-Ship\resources\views/emails/contact-auto-reply.blade.php ENDPATH**/ ?>