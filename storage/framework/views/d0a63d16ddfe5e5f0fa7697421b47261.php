...
<?php $__env->startSection('page_title', 'Track Shipment'); ?>
<?php $__env->startSection('meta_description', 'Track your SwiftShip shipment in real-time. Enter your tracking number to get live GPS location, delivery ETA, and status updates.'); ?>
  ...
  <div class="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 py-12">
    <div class="grid grid-cols-1 lg:grid-cols-[1fr_460px] gap-12 items-center">
      ...
      <div class="rounded-2xl border border-slate-800 bg-slate-900/80 backdrop-blur p-7 shadow-2xl shadow-black/30">
        ...
        <form method="GET" action="<?php echo e(route('tracking.lookup')); ?>" id="track-form"
        ...
        <div class="mt-5 pt-5 border-t border-slate-800">
          ...
          <div class="flex flex-wrap gap-2">
            ...
            <button type="button" onclick="document.getElementById('track-input').value='<?php echo e($ex); ?>'"
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Swift-Ship\resources\views/tracking/lookup.blade.php ENDPATH**/ ?>